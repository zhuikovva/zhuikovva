...
Перед тем как искать работу, я проанализировал рынок вакансий *Дата Аналитики* — и превратил это исследование в проект. Исследование рынка можно <a href="https://github.com/zhuikovva/motivation_project" target="_blank">здесь</a>. Сделал пайплайн загрузки, обработки и выгрузки в свою базу данных. На этой основе <a href="https://github.com/zhuikovva/vacancies_hh_parsing_bot" target="_blank">телеграм-бот</a>, который помогает в поиске работы, а также подсчитываю <a href="https://datalens.yandex/cwv235842drwy" target="_blank">статистику вакансий в режиме реального времени</a>.
